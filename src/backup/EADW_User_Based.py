...
class DataSet:
    ...
    def getUsersThatRate(self,movie):
        ...
        users = set()
        for (user, v) in self.dic.iteritems():
            if movie in self.dic[user]:
    ...
    def printDic(self,user):
        print self.dic[user].keys()
    def getMean(self):
        return self.mean
